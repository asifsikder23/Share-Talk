    ...
    <div>
      <main class="profile-page">
        <section class="relative block h-500-px">
          ...
          <div class="top-auto bottom-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden h-70-px trans">
            <svg
                  ...
                  <div class="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                    <div class="relative">
                      <img
                        alt="..."
                        src={photo}
                        class="shadow-xl rounded-full h-auto align-middle border-none absolute -m-16 -ml-20 lg:-ml-16 max-w-150-px ring ring-indigo-600 ring-offset-base-100 ring-offset-2 w-48"
                      />
                    </div>
                  </div>
