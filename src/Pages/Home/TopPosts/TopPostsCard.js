...
import PostComment from '../../Media/PostComment';

const TopPostsCard = ({topPost}) => {
  const { photo, name, postMessage, images, privacy, like, _id } = topPost;
  console.log(topPost);
  ...
  const handleLike = (_id) => {
    ...
    fetch(`https://share-talk-server.vercel.app/like/${_id}`, {
      method: "PUT",
    })
      .then((res) => res.json())
      .then((data) => {
